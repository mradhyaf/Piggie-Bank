...
export default function ExpensesScreen({ navigation }) {
  ...
  return (
    <Screen title={`Monthly Expenses: $${priceTotal(inTheMonthOf(month, year, useSelector(selectExpenses)))}`}
      enableAppbar={true}>
      ...
      <Text style={{textAlign:'right'}}>
        Yearly Total: ${priceTotal(inTheYearOf(year, useSelector(selectExpenses)))}
      </Text>
